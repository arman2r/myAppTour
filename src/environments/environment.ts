...
export const environment = {
  production: false,
  politics: {
    title: `Privacy Policy for Cheisen`,
    ...
    <br /><br />
    Application refers to Cheisen, the software program provided by the
    Company.
    <br /><br />
    Company (referred to as either "the Company", "We", "Us" or "Our" in
    this Agreement) refers to Cheisen, Calle 10#1-28.
    <br /><br />
    ...
    <br /><br />
    Google Facebook Instagram Twitter LinkedIn If You decide to register
    ...
    Personal Data that We have collected about You. <br /><br />
    ...
    <h4>Children's Privacy Our Service</h4>
    does not address anyone under the age of 13. We do not knowingly
    ...
    to remove that information from Our servers. <br /><br />
    ...
    us:
    <br /><br />
    By email: atencionalusuario&#64;cheisen.com
    <br /><br />
    By visiting this page on our website: http://www.cheisen.com/contacto`,
  },
  managementInformation: {
    title: `Manejo de la información`,
    description: `<h1>Manejo de la información</h1>
    Last updated: June 07, 2024
    <br /><br />
    This Privacy Policy describes Our policies and procedures on the
    collection, use and disclosure of Your information when You use the
